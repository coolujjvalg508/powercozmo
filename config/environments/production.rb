Rails.application.configure do
  ...
  ActionMailer::Base.default :from => "PowerCozmo <notifications@powercozmo.com>"
  ...
  config.assets.compile = true #enabled it since assets failed to compile. it may slow down performance
